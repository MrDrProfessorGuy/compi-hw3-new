...
{token_if}        yylval.NodeToken = (new Node_Token(yytext));Frame_class::getInstance().newFrame(FrameType::IF_WHILE);return IF;
{token_else}      yylval.NodeToken = (new Node_Token(yytext));Frame_class::getInstance().newFrame(FrameType::IF_WHILE);return ELSE;
{token_while}     yylval.NodeToken = (new Node_Token(yytext));Frame_class::getInstance().newFrame(FrameType::IF_WHILE);return WHILE;
